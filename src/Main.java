public class Main {
    public static void main(String[] args) {
        ...
        Pocima kriptonitaDos = new PocimaPorcentual("Kriptonita", -35);
        Pocima reductorPlomo = new PocimaPorcentual("Reductor Plomo", -55);
        Pocima reductorPlomoDos = new PocimaPorcentual("Reductor Plomo", -65);
        Pocima valeCuatro = new PocimaValorFijo("Vale Cuatro", 4);
        Pocima valeCuatroDos = new PocimaValorFijo("Vale Cuatro", 6);
        Pocima numeroMagico = new PocimaValorFijo("Número Mágico", 23);
        Pocima numeroMagicoDos = new PocimaValorFijo("Número Mágico", 24);
        Pocima selectivaFuerza = new PocimaSelectiva("Selectiva Fuerza", "fuerza", 35);
        Pocima selectivaFuerzaDos = new PocimaSelectiva("Selectiva Fuerza", "fuerza", 36);
        Pocima selectivaPeso = new PocimaSelectiva("Selectiva Peso", "peso", 43);
        Pocima selectivaPesoDos = new PocimaSelectiva("Selectiva Peso", "peso", 44);
